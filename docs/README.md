...
* *Navigation Buttons* (Buttons 3, 4 and 5) which manipulate the structure of a proof (available on *hover*)
	...
	* **Expand** (Button 4): clicking this button shows the immediate nodes leading to the selected node.
	* **Collapse** (Button 5): clicking this button hides the immediate nodes leading to the selected node, and thus the corresponding subtrees.
